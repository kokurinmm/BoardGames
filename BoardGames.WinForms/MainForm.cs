...
public partial class MainForm : Form
{
    ...
    private void btnHelp_Click(object sender, EventArgs e)
    {
        MessageBox.Show(
                ...
                "Против вас будут играть два алгоритма ИИ. Алгоритм альфа-бета отсечения просчитывает ходы на заданную " +
                "глубину. Алгоритм Monte Carlo Tree Search на протяжении всей партии строит дерево ходов с их оценками, " +
                "запускает случайные доигрывания партий из разных позиций и глубоко исследует перспективные ветви. " +
                "В шашках доигрывания неизученных позиций полностью случайные, в реверси и уголках — не совсем.\n\n" +
