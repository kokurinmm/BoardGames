...
public partial class MainForm : Form
{
    ...
    private void btnHelp_Click(object sender, EventArgs e)
    {
        MessageBox.Show(
                ...
                "Побитые фигуры удаляются с доски только после окончания хода и дамка не может побить одну и ту же фигуру " +
                "дважды за один ход. После 15 ходов только дамками без взятий объявляется ничья.\n\n" +
