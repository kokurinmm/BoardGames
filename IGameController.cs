...
public interface IGameController // Общий интерфейс для всех доступных игр
{
    ...
    int MaxDepth { get; } // максимальная доступная глубина для алгоритма альфа-бета отсечения
    int MonteCarloSimulations { get; set; } // количество симуляций для метода Монте-Карло (не используется)
    ...
    /// <summary>
    /// Если сейчас ход ИИ, выполнить его ход и вернуть true
    /// </summary>
    bool MakeAiTurn();
